...
to be automated by a computer program.

This lesson introduces an open source tool for processing image data:
[ImageJ](https://imagej.net), specifically one flavour of imageJ, known as [Fiji](https://fiji.sc).
With careful experimental design,
ImageJ can be a powerful instrument in answering many different kinds of questions.
...
of working with image data in ImageJ.
...
![](fig/intro/colonies-01.jpg){alt='a few bacterial colonies on a petri dish' .no-invert}
...
![](fig/intro/colony-mask.png){alt='bacterial colonies highlighted by segmentation and connected component analysis' .no-invert}
...
Why should we learn how to manually to do a task
...
![](fig/intro/colonies-03.jpg){alt='several hundred bacterial colonies on a petri dish' .no-invert}
...
and much more quickly, than a human could. And it would do it the same again, highlighting reproducibility.
...
2. What if you have hundreds, or thousands, of images to consider?
  ...
  like those above.
  An ImageJ macro could process many images in seconds;
...
- Simple, but not basic, image analysis techniques can be used to solve genuine image analysis problems.
