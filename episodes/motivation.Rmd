...
knitr::include_graphics("fig/intro/colonies-01.jpg")
```
...
![bacterial colonies highlighted by segmentation and connected component analysis](fig/intro/colony-mask.png){: .no-invert}
...
![several hundred bacterial colonies on a petri dish](fig/intro/colonies-03.jpg){: .no-invert}
